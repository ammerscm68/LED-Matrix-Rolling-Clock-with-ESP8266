...
{ /* &nbsp = Leerzeichen | <meta http-equiv=\"refresh\" content=\"30\">\ = Refresh alle 30 sekunden*/ 
  ...
  String MB1, MB2, MB3, MB4, MB5, rtime;
 ...
 //  Serial.println("<a"+InTempOnOff2+"</a>\"); // Only for Debuging 
  ...
  <style>\
   ...
   #Bvalue {color: #2ECCFA;}\
    ...
    <a href =\"/moff\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">Display AUS</button></a>\
    <a href =\"/mon\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">Display EIN</button></a>\
    <a href =\"/m1\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">"+MB1+"</button></a>\
    <a href =\"/m2\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">"+MB2+"</button></a>\
    <a href =\"/m3\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">"+MB3+"</button></a>\
    <a href =\"/m4\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">"+MB4+"</button></a>\
    <a href =\"/m5\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 95px;\">"+MB5+"</button></a>\
    <p></p>\
    ...
    <a href =\"/reboot\"><button class=\"button\" style=\"margin-right: 30px;height: 48px; width: 120px;color: blue;float: right; font-size: 16px;\">Neustart</button></a>\
    <a><br /></a>\
    <a><br /></a>\
...
HTMLString = "<!DOCTYPE html> <html>\
  ...
  <style>\
   ...
   h3 { font-size: 24px; margin-top: 0px; margin-bottom: 10px; }\
    ...
    <a><br /></a>\
    <h2>WLAN SSID:&nbsp;&nbsp;"+ssid+"</h2>\
    <h2>IP-Adresse:&nbsp;&nbsp;&nbsp;"+CheckIP+"</h2>\
    <a><br /></a>\  
