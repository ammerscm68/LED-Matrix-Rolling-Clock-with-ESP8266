...
String FederalState = ""; // State abbreviation (view Bottom) Example: TH = Thüringen / "" = only federal holidays / NGH = No German Holiday's
// #############################################################################################################################################
...
// nur Innen- und Außenluftfeuchte --- 3x pro Stunde (default)
  ...
  if  (String(m)+":"+String(s) == DateNewsViewTime[i]+":8") { 
    ...
    Greetings_and_Holiday(false);} // Grüße und Feiertage
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
