// **********************************(newsdata.io)******************************************
// Test -->  https://newsdata.io/api/1/latest?country=ie&language=en&apikey==yourAPIKey
// *****************************************************************************************
...
String authors[authors_Count] = {"Euronews", "Irish Mirror", // Json "source_name" IE Authors
                                 "Independent", "The Irish Times", "Dublin Live", 
                                 "The42", "The Irish Sun", "Sky Sports", "Extra.ie", 
                                 "Irish Examiner", "Irishcentral"};

/*****************************************************************************************************************************/ 
String Country = F("ie"); // Country Default is ie = Irish
