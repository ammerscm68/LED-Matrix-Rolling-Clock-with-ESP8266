...
String WatchOwner1FirstName = "Mario"; // Vorname des Hauptbesitzers - Example: Mario
String WatchOwner1LastName  = "Ammerschuber"; // Nachname des Hauptbesitzers - Example: Müller
String Gender1 = "male";  // male=männlich | female=weiblich
String Birthday1 = "17.3"; // Example: 17.3 or 2.4 or 5.10 or 23.11
// **************************************************************************************************
// ************************ 2. Besitzer (Optional) **************************************************
...
// ##### Angabe des deutschen Bundeslandes für die Feiertagsberechnung (siehe ganz unten)  - kann ab Version 9.4.0 im Captiv Portal geändert werden #########
String FederalState = "TH"; // Bundesländer Feiertage (siehe unten) 
...
// ###### Anzeigezeiten für "OpenWeatherMAP" und "NewsData" sowie Innen-/Außentemperatur- und Luftfeuchte (DHT-Sensor) ####
