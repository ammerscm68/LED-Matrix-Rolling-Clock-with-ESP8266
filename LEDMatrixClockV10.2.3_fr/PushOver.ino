...
if (SerialMonitor) {Serial.println("Envoyer un Message Pushover à "+PushoverDevice1);}
if (NIHS >= 90 ) {
...
Serial.println("Le Message Pushover à "+PushoverDevice1+" n'a pas pu être envoyé !");} 
...
if (SerialMonitor) {Serial.println("Envoyer un Message Pushover à "+PushoverDevice2);}
if (NIHS >= 90 ) {
printStringWithShift("             ", ScrollTextTime);    
printStringWithShift("P-Over", ScrollTextTime);   
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice2,"siren"); // Envoyer un message à l'appareil 2
if (SerialMonitor && FailPushOver) {
Serial.println("Le Message Pushover à "+PushoverDevice2+" n'a pas pu être envoyé !");}
printStringWithShift("             ", ScrollTextTime);} else {
printStringWithShift("P-Over", ScrollTextTime);      
...
if (SerialMonitor) {Serial.println("Envoyer un Message Pushover à "+PushoverDevice3);}
if (NIHS >= 90 ) {
printStringWithShift("             ", ScrollTextTime);    
printStringWithShift("P-Over", ScrollTextTime);   
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice3,"siren"); // Envoyer un message à l'appareil 3
if (SerialMonitor && FailPushOver) {
Serial.println("Le Message Pushover à "+PushoverDevice3+" n'a pas pu être envoyé !");}
printStringWithShift("             ", ScrollTextTime);} else {
printStringWithShift("P-Over", ScrollTextTime); 
