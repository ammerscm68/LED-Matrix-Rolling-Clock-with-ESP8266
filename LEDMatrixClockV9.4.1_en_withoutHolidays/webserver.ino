...
else { // Additional features birthday text
...
if (WebFunction == "EnhancedFunctionsOFF1") {HTMLAnswerString = "The additional Functions have been activated<br />(Date, Birthdays)";}
if (WebFunction == "EnhancedFunctionsOFF2") {HTMLAnswerString = "The additional Functions are already switched ON<br />(Date, Birthdays)";}
