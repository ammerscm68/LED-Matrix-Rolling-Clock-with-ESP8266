...
// Zusatzfunktionen
  ...
  EF1 = "<a href =\"/zfein\"><button class=\"button\" style=\"margin-right: 10px; color: red; height: 26px; width: 90px;\">EIN*</button></a>";}
  } else {
...
// NewsAPI Einschalten / Ausschalten
  ...
  NAF2 = "<a href =\"/nafaus\"><button class=\"button\" style=\"margin-right: 10px; color: blue; height: 26px; width: 90px;\">AUS*</button></a>";} else {
  NAF2 = "<a href =\"/nafaus\"><button class=\"button\" style=\"margin-right: 10px; height: 26px; width: 90px;\">AUS</button></a>";} 
  ...
  if (StatusNewsAPI == "OK") {
  ANA += "<a href =\"/cn\"><button class=\"button\" style=\"font-family:arial; font-size: 14px; margin-right: 10px; color:blue; margin-left: 110px; height: 26px; width: 160px;\">aktuelle Nachricht</button>";} else {
  if (StatusNewsAPI == "Fehler") {
  ANA += "<a href =\"/cn\"><button class=\"button\" style=\"font-family:arial; font-size: 14px; margin-right: 10px; color:red; margin-left: 110px; height: 26px; width: 160px;\">aktuelle Nachricht</button>";} else {
