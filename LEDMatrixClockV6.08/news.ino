...
{
/*****************************************************************************************************************************/
int authors_Count = 13;  
String authors[authors_Count] = {"Tagesschau.de", "Bild", "Der Spiegel", "WDR Nachrichten", "n-tv NACHRICHTEN",
                                 "NDR.de", "rbb24", "WELT", "Rheinische Post", "NOZ", "Süddeutsche Zeitung - SZ.de",
                                 "finanzen.net", "MDR"};  // German Authors
/*****************************************************************************************************************************/ 
...
// http.addHeader("Content-Type", " application/x-www-form-urlencoded; charset=UTF-8");
   ...
   MyWaitLoop(1000); //wait
    ...
    // for Debug Mode
    /*Serial.println("articles_0_author: "+ articles_0_author);
    Serial.println("articles_1_author: "+ articles_1_author);
    Serial.println("articles_2_author: "+ articles_2_author);
    Serial.println("articles_3_author: "+ articles_3_author);
    Serial.println("articles_4_author: "+ articles_4_author);
    Serial.println("articles_5_author: "+ articles_5_author);
    Serial.println("articles_6_author: "+ articles_6_author);
    Serial.println("articles_7_author: "+ articles_7_author);
    Serial.println("articles_8_author: "+ articles_8_author);
    Serial.println("articles_9_author: "+ articles_9_author);
    Serial.println("articles_10_author: "+ articles_10_author);
    Serial.println("articles_11_author: "+ articles_11_author);
    Serial.println("articles_12_author: "+ articles_12_author);
    Serial.println("articles_13_author: "+ articles_13_author);
    Serial.println("articles_14_author: "+ articles_14_author);
    Serial.println("articles_15_author: "+ articles_15_author);
    Serial.println("articles_17_author: "+ articles_16_author);
    Serial.println("articles_17_author: "+ articles_17_author);
    Serial.println("articles_18_author: "+ articles_18_author);
    Serial.println("articles_19_author: "+ articles_19_author);*/
