...
/*****************************************************************************************************************************/
int authors_Count = 8;  
String authors[authors_Count] = {"The Irish Times", "RTE.ie", "TheJournal.ie", "EchoLive.ie", "Irish Mirror",
                                 "Irish Independent", "The Irish Sun", "BreakingNews.ie"};  // Irish Authors
/*****************************************************************************************************************************/ 
String Country = F("ie"); // Default ie = Irish English
/*****************************************************************************************************************************/
...
HTTPClient http;  
APINews = F(""); // Initialize variable
StatusNewsAPI = F("n/a"); 
NewsAPILastConnectionDateTime = FormatedDateTimeEN(); // Connection Time;
...
Serial.println(F("Download News - Please wait ..."));} 
 ...
 // DynamicJsonDocument doc2(ESP.getMaxAllocHeap()); // for ESP32
    ...
    // Search Data  
    if (SerialMonitor) {Serial.println("Parse Authors: "+FormatedDateTimeEN());}
