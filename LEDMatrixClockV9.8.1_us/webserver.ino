...
OWMA =  CreateButton("ON",false,"owmfon","","80","10","disabled");
OWMA += CreateButton("OFF",true,"owmfoff","","80","10","disabled");
OWMA += CreateButton("Weather",false,"aowmn","","80","10","disabled");
...
HTMLString =  F("<h2>Selection - Display Current Weather Data from ---OpenWeatherMAP--- &nbsp; ON / OFF / WEATHER / STATUS:</h2>");
HTMLString += OWMA;
HTMLString += F("<p></p>");
HTMLString += F("<hr style=\"border-top: 3px solid #095484;margin-left: 0px;width: auto;\">");
return HTMLString;}
...
ANA =  CreateButton("ON",false,"nafon","","80","10","disabled");
ANA += CreateButton("OFF",true,"nafoff","","80","10","disabled");
ANA += CreateButton("News",false,"aapin","","80","10","disabled");
...
HTMLString = F("<h2>Selection - Show Current News from ---NewsAPI--- &nbsp; ON / OFF / NEWS / STATUS:</h2>");
HTMLString += ANA;
HTMLString += F("<p></p>");
HTMLString += F("<hr style=\"border-top: 3px solid #095484;margin-left: 0px;width: auto;\">");
return HTMLString;}
...
if (WebFunction == "TMPushoverDevice1") {HTMLAnswerString = "The Pushover Test Message was sent to "+PushoverDevice1;} 
if (WebFunction == "TMPushoverDevice2") {HTMLAnswerString = "The Pushover Test Message was sent to "+PushoverDevice2;} 
if (WebFunction == "TMPushoverDevice3") {HTMLAnswerString = "The Pushover Test Message was sent to "+PushoverDevice3;} 
HTMLString = F("<!DOCTYPE html> <html lang='en-US'>");
HTMLString +=  F("<head>");
HTMLString +=  F("<title>LED-Matrix-Clock</title>");
HTMLString +=  F("<meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\">");
...
HTMLString += F("<h1>LED-Matrix-Clock</h1>");
HTMLString += F("<a><br /></a>");
HTMLString += "<h2>News from: "+NewsAPILastConnectionDateTime+"</h2>";
