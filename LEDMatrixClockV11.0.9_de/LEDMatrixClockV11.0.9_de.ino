 ...
 ********************************************************************************************
*/
const char* LMCVersion = "11.0.9 de";
...
await = false;} // Start der Uhr - Ende
  ...
  if (IsEnoughRAM(MinRAMMem,"Wetter") && IsWiFiSignalOK()) {MEP=true; getWeatherData(); MEP=false;}} // Neuen Sonnenauf- und Sonnenuntergang ermitteln
...
// ----------- nur Innen- und Außenluftfeuchte  ---------------------- 
  ...
  if (IsEnoughRAM(MinRAMMem,"News") && IsWiFiSignalOK()) {MEP=true; getNews(); MEP=false;} else {APINews.clear();}} // aktuelle News
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
