 ...
 ********************************************************************************************
*/
const char* LMCVersion = "10.2.9 de";
...
void loop() {  
  ...
  if (SerialMonitor) {Serial.println("WLAN-Verbindung: getrennt - "+FormatedDateTimeDE(false));
  ...
  Serial.println(F("Die Uhr wird neu gestartet..."));}
