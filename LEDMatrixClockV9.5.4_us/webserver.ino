...
String RefreshTime = "60"; // Refresh Website after X seconds
  ...
  if (IntInTempValue >= 50 && IntInTempValue <= 82) {InTempOnOff1 = "id= 'Gvalue'>Temperature on the Clock:";} else {  
...
if (HT1 != "") {
HTMLString += "<a style=\"font-family:arial; color: aqua; font-size: 16px; margin-left: 40px;\">Heute: &nbsp;&nbsp;"+HT1+"</a>";}}} else { // Additional features
if (EnhancedFunctions) {
...
if (WebFunction == "MatrixOff") {HTMLAnswerString = "The LED Matrix Display is switched OFF";} 
...
if (WebFunction == "EnhancedFunctionsON1") {HTMLAnswerString = "The additional Functions have been activated<br />(Date, Holidays, Birthdays)";}
if (WebFunction == "EnhancedFunctionsON2") {HTMLAnswerString = "The additional Functions are already switched ON<br />(Date, Holidays, Birthdays)";}
if (WebFunction == "EnhancedFunctionsOFF") {HTMLAnswerString = "The additional Functions have been switched OFF<br />(Date, Holidays, Birthdays)";}
...
Display = false; 
if (WeatherFunctions) {StatusOpenWeatherMap = "enabled";}  
if (NewsAPIFunction) {StatusNewsAPI = "enabled";}  
HTMLAnswer("MatrixOff");
if (SerialMonitor) {Serial.println("The LED Matrix is turned off.");} 
...
if (SerialMonitor) {Serial.println("Additional Functions switched on - (Date, Holidays, Birthdays)");} 
} else {PleaseWait();}}
...
if (SerialMonitor) {Serial.println("Additional Functions switched off - (Date, Holidays, Birthdays)");}
} else {PleaseWait();}}
