...
if (WebFunction == "MatrixOff") {HTMLAnswerString = "Das LED-Matrix Display wird ausgeschaltet";} 
...
Display = false; 
if (WeatherFunctions) {StatusOpenWeatherMap = "aktiviert";}  
if (NewsAPIFunction) {StatusNewsAPI = "aktiviert";}  
HTMLAnswer("MatrixOff");
if (SerialMonitor) {Serial.println("Die LED-Matrix wird ausgeschaltet.");} 
