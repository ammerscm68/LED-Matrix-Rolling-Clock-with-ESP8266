...
HTMLString += "<a><br /></a>";
if (ESPRAM > 2) {
HTMLString += "<h7>Arbeitsspeicher: &nbsp;&nbsp;"+String(ESPRAM)+" kB</h7>";} else {
HTMLString += "<h8>Arbeitsspeicher: &nbsp;&nbsp;"+String(ESPRAM)+" kB (Achtung ! - zu wenig)</h8>";}
HTMLString += "<a><br /></a>";
...
String OnOffAndLevelButton(String BMark, bool Bselect, String BHRef, String Blevel, String Bwidth, String BRmargin) {
String HTMLString = "";
if (Bselect) {
HTMLString  = "<a href =\"/"+BHRef+"\"><button class=\"button\" style=\"margin-right: "+BRmargin+"px; color: blue; height: 26px; width: "+Bwidth+"px;\">"+BMark+Blevel+"*</button></a>";} else {
HTMLString += "<a href =\"/"+BHRef+"\"><button class=\"button\" style=\"margin-right: "+BRmargin+"px; height: 26px; width: "+Bwidth+"px;\">"+BMark+Blevel+"</button></a>";}
return HTMLString;
}
