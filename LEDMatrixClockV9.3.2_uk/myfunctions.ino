...
if (HolidayDate == First_Monday(5)) {HoliDayText = "Early May Bank Holiday";}   // May Bank Holiday
if (HolidayDate == Last_Monday(5)) {HoliDayText = "Spring Bank Holiday";}   // Spring Bank Holiday
if (HolidayDate == "25.12") {HoliDayText = "Christmas Day";} // 1st Christmas Holiday
if (HolidayDate == "26.12") {HoliDayText = "Boxing Day";} // Second Christmas Day
...
Serial.println(""); } 
if (EasterSunday==HDay)  {HoliDayText = "Easter Sunday";}     // Easter Sunday
if (EasterSunday-2==HDay)  {HoliDayText = "Good Friday";}   // Good Friday
if (EasterSunday+1==HDay)  {HoliDayText = "Easter Monday";}   // Easter Monday
if (EasterSunday+39==HDay)  {HoliDayText = "Ascension of Christ";}  // Ascension of Christ
if (EasterSunday+49==HDay)  {HoliDayText = "Pentecost Sunday";}  // Pentecost Sunday
if (EasterSunday+50==HDay)  {HoliDayText = "Pentecost Monday";}}  // Pentecost Monday
