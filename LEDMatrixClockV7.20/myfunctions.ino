...
if (Gender1 == "male") {  // Geburtstagsgruß an Hauptbesitzer
GreetingText = "Alles gute zum Geburtstag lieber "+WatchOwner1;} else {
...
if (Gender2 == "male") { // Geburtstagsgruß an 2. Besitzer 
GreetingText = "Alles gute zum Geburtstag lieber "+WatchOwner2;} else {
...
if (Gender3 == "male") { // Geburtstagsgruß an 3. Besitzer 
GreetingText = "Alles gute zum Geburtstag lieber "+WatchOwner3;} else {
