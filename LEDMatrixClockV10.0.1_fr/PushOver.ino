...
Serial.println(F("Connectez-vous au Serveur PushOver.net..."));}
...
if (SerialMonitor) {
Serial.println(F(""));
Serial.println("[Pushover] - Envoyer un Message: "+POMessage); Serial.println(F(""));}
...
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice1,"siren"); // Send Message to Device 1
...
printStringWithShift("P-Over", ScrollTextTime);      
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice1,"none"); // Send Message to Device 1
if (SerialMonitor && FailPushOver) {
Serial.println("The Pushover Message to "+PushoverDevice1+" could not be sent!");}
...
if (NIHS >= 90 ) {
printStringWithShift("P-Over", ScrollTextTime);   
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice2,"siren"); // Send Message to Device 2
if (SerialMonitor && FailPushOver) {
Serial.println("The Pushover Message to "+PushoverDevice2+" could not be sent!");}
printStringWithShift("          ", ScrollTextTime);} else {
printStringWithShift("P-Over", ScrollTextTime);      
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice2,"none"); // Send Message to Device 2 
if (SerialMonitor && FailPushOver) {
Serial.println("The Pushover Message to "+PushoverDevice2+" could not be sent!");}
printStringWithShift("          ", ScrollTextTime);}}   
...
if (NIHS >= 90 ) {
printStringWithShift("P-Over", ScrollTextTime);   
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice3,"siren"); // Send Message to Device 3
if (SerialMonitor && FailPushOver) {
Serial.println("The Pushover Message to "+PushoverDevice3+" could not be sent!");}
printStringWithShift("          ", ScrollTextTime);} else {
printStringWithShift("P-Over", ScrollTextTime); 
SendPushoverMessage(cleanText(MPushOverMessage),PushoverDevice3,"none"); // Send Message to Device 3
if (SerialMonitor && FailPushOver) {
Serial.println("The Pushover Message to "+PushoverDevice3+" could not be sent!");}
printStringWithShift("          ", ScrollTextTime);}}  
}} 
...
if (SerialMonitor) {Serial.println("La Force du Signal WiFi est trop faible !");}} else {  
if (!MEP) {  
if (!await){ 
await = true;
MEP = true; 
