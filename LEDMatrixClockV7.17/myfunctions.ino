...
// ***************************** "Geburtstage oder/und andere Grüße" ********************************* 
...
//                                       "Alles gute zum Geburtstag lieber Klaus"};  
// ---------------------------------------------------------------------------------------------------
// String GreetingsDate[GreetingsCount] {"5.3"};
// String GreetingsText[GreetingsCount] {"Alles gute zum Geburtstag lieber Klaus-Peter"};
// ---------------------------------------------------------------------------------------------------
// String GreetingsDate[GreetingsCount] {"17.3"};
// String GreetingsText[GreetingsCount] {"Alles gute zum Geburtstag"};
// ---------------------------------------------------------------------------------------------------  
// String GreetingsDate[GreetingsCount] {"8.3"};
// String GreetingsText[GreetingsCount] {"Alles gute zum Geburtstag liebe Manuela"}; 
// --------------------------------------------------------------------------------------------------- 
// String GreetingsDate[GreetingsCount] {"1.4"};
// String GreetingsText[GreetingsCount] {"Alles gute zum Geburtstag lieber Rolf"}; 
// --------------------------------------------------------------------------------------------------- 
// String GreetingsDate[GreetingsCount] {"4.10"};
// String GreetingsText[GreetingsCount] {"Alles gute zum Geburtstag liebe Christine"}; 
// ---------------------------------------------------------------------------------------------------                                                                                                                                                                                                                                                                             
