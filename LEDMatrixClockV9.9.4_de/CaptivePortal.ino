...
// RemoteAPIKeyUpdate("N","pub_552345457w4225925b2391d3cdd5dfcf5e4",""); // N= News-Modul  /  W= Wetter-Modul  / Leer = kein Update  - APIKey
// RemoteAPIKeyUpdate("W","97442572457fdb62f590552ab76f6a89","2918752"); // N= News-Modul  /  W= Wetter-Modul  / Leer = kein Update  - APIKey,CityID
