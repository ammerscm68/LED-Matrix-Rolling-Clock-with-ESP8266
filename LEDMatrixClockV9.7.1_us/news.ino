...
/*****************************************************************************************************************************/
int authors_Count = 4;  
String authors[authors_Count] = {"The Associated Press", "Reuters", "The Daily Beast", "AFP"};  // United States Authors
/*****************************************************************************************************************************/ 
String Country = F("us"); // Default us = United States English
/*****************************************************************************************************************************/
...
StatusNewsAPI = F("n/a"); 
NewsAPILastConnectionDateTime = FormatedDateTimeUS(); // Connection Time;
...
Serial.println(F("Download News - Please wait ..."));} 
 ...
 // DynamicJsonDocument doc2(ESP.getMaxAllocHeap()); // for ESP32
    ...
    Serial.println(F(""));}
        ...
        // Search Data  
    if (SerialMonitor) {Serial.println("Parse Authors: "+FormatedDateTimeUS());}
