...
if (SerialMonitor) {Serial.println("Matrix switched off via Button at "+ FormatedDateTimeUS());} 
}
else
    {
    ...
    // ShortBuzzerBeep();
    if (SerialMonitor) {Serial.println("Matrix switched on via Button at "+ FormatedDateTimeUS());}} else
    {
...
if (SerialMonitor) {Serial.println("UDP Server started - "+FormatedDateTimeUS());}}

// *************************************************************************************************

void WiFiUDPStop() {
Udp.stop();
if (SerialMonitor) {Serial.println("UDP Server stopped - "+FormatedDateTimeUS());}}

// *************************************************************************************************

void WebServerStart() {
server.begin();
if (SerialMonitor) {Serial.println("Web Server started - "+FormatedDateTimeUS());}}

// *************************************************************************************************

void WebServerStop() {
server.stop();
if (SerialMonitor) {Serial.println("Web Server stopped - "+FormatedDateTimeUS());}}
