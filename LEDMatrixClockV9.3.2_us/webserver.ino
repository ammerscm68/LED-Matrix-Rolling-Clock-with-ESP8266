...
/* &nbsp = Space | <meta http-equiv=\"refresh\" content=\"60\">\ = Refresh alle 60 sekunden*/ 
...
if (HT1 != "") {
HTMLString += "<a style=\"font-family:arial; color: aqua; font-size: 16px; margin-left: 40px;\">ToDay: &nbsp;&nbsp;"+HT1+"</a>";}}} else { // Additional features birthday text
...
if (WebFunction == "EnhancedFunctionsOFF1") {HTMLAnswerString = "The additional Functions have been activated<br />(Date, Holidays, Birthdays)";}
if (WebFunction == "EnhancedFunctionsOFF2") {HTMLAnswerString = "The additional Functions are already switched ON<br />(Date, Holidays, Birthdays)";}
