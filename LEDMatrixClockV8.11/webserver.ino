...
// Innenfeuchtigkeit - Meldung wenn zu niedrig oder zu hoch
  ...
  InHumMessage = "Achtung: Luftfeuchte zu niedrig !";}
  if (IntInHumValue >= 68) {
  if (WeatherFunctions and Display){
  if (humidity >= 68 || humidity == -1) {InHumMessage = "Achtung: Luftfeuchte zu hoch !";} else 
  {InHumMessage = "Achtung: Luftfeuchte zu hoch ! - Bitte Lüften";}
  } else {InHumMessage = "Achtung: Luftfeuchte zu hoch !";}}}} // Luftfeuchte zu hoch}   
...
HTMLString += "<a><br /></a>";
if (WatchOwner1 != "") {
HTMLString += "<h2>Besitzer der Uhr:&nbsp;&nbsp;"+WatchOwner1+"</h2>";
HTMLString += "<a><br /></a>";  
}
