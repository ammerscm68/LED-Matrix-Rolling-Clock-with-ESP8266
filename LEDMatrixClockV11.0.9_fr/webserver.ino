  ...
  <style>\
   ...
   h3 {font-size: 28px; margin-top: 0px; margin-bottom: 10px; margin-left: 10px;}\
    ...
    <a><br /></a>\
     ...
     <a><br /></a>\
     <a href =\"/goreset\"><button class=\"button\" style=\"height: 48px; width: 110px; font-size: 22px; color: red\">Oui</button></a>\
  ...
  <style>\
   ...
   h3 {font-size: 28px; margin-bottom: 10px; margin-left: 10px;}\
    ...
    <h1>Horloge-Matricielle-LED</h1>\
     ...
     <a><br /></a>\
     <a href =\"/reboot\"><button class=\"button\" style=\"height: 48px; width: 110px; font-size: 22px; color: red\">OUI</button></a>\
     <a href =\"/\"><button class=\"button\" style=\"margin-left: 80px;height: 48px; width: 110px; font-size: 22px;\">NON</button></a>\
  </body>\
    </html>"); 
OneTimeCall = true;        
