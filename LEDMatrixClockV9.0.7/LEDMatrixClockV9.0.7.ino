...
int DoublePointPermanantTimeCount = 11; // Anzahl der Zeiten
...
if (WatchOwner1FirstName != "") {
String SHT= "       +++   Hallo  "+WatchOwner1FirstName+"    ---    Die Uhr wird gestartet...       +++                    "; 
...
if (InTempValue != "-") { 
   // Anzeigen das DHT-Sensor bereit
  ...
  digitalWrite(HWLEDPin, HIGH);} // LED Ein- oder Ausschalten
  } else {digitalWrite(HWLEDPin, LOW);} // LED Ausschalten
...
await = false;} // Start der Uhr - Ende
  ...
  await = true; ShowGhost(); getTimeLocal(); await = false;}}
