...
if (SerialMonitor) {Serial.println("Greeting: "+GT);}  
SIC == true; // for ScrollIn Clock 
printStringWithShift(GT.c_str(), ScrollTextTime);}} // Output GreetingText
}
}
...
Serial.println("");}
printStringWithShift(HT.c_str(), ScrollTextTime);} else { // Output HoliDayText
if (SerialMonitor) {
Serial.println("");   
...
Serial.println(""); }}}
} // End function "void Greetings_and_Holiday()"
