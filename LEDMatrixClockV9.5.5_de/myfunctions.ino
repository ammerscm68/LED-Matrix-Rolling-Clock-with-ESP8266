...
FederalState == "SL" || FederalState == "SN" || FederalState == "TH")) {HoliDayText = "Fronleichnam";}}  
...
InHumValue = InHumMessure();
  ...
  if (Display) {digitalWrite(HWLEDPin, HIGH);} else {digitalWrite(HWLEDPin, LOW);}  // LED Einschalten oder Ausschalten 
  ...
  digitalWrite(HWLEDPin, LOW); // LED Ausschalten
  InHumMessage = F("");}} else {digitalWrite(HWLEDPin, LOW); // LED Ausschalten
  InHumMessage = F("");}  
}
...
if (sfs == "BW") lfs = "Baden-Württemberg"; 
if (sfs == "BY") lfs = "Bayern";  
if (sfs == "BE") lfs = "Berlin";  
if (sfs == "BB") lfs = "Brandenburg";  
if (sfs == "HB") lfs = "Bremen";  
if (sfs == "HH") lfs = "Hamburg";  
if (sfs == "HE") lfs = "Hessen";  
if (sfs == "MV") lfs = "Mecklenburg-Vorpommern";  
if (sfs == "NI") lfs = "Niedersachsen";  
if (sfs == "NRW") lfs = "Nordrhein-Westfalen";  
if (sfs == "RP") lfs = "Rheinland-Pfalz";  
if (sfs == "SL") lfs = "Saarland";  
if (sfs == "SN") lfs = "Sachsen";  
if (sfs == "SA") lfs = "Sachsen-Anhalt";  
if (sfs == "SH") lfs = "Schleswig-Holstein";  
if (sfs == "TH") lfs = "Thüringen"; 
