...
Serial.println(F("Wetterdaten werden heruntergeladen - Bitte warten ..."));}
 ...
 // DynamicJsonDocument doc(ESP.getMaxAllocHeap()); // for ESP32 
    ...
    StatusOpenWeatherMap = "Fehler";} 
     ...
     if (SerialMonitor) {
     Serial.println(F("OpenWeatherMap wird deaktiviert! ...")); 
     Serial.println(F(""));}  
      }} else {
    if (SerialMonitor) {  
    Serial.println("[HTTP] GET... code: " + HTTPCodeText(httpCode));
...
client.flush();
client.stop(); // Client beenden
if (SerialMonitor) {Serial.println(F("Verbindung zum OpenWeatherMap-Server fehlgeschlagen !"));}}} //error message if no client connect
// ==================================================================================================================================
// ==================================================================================================================================
