...
String RefreshTime = F("60"); // Aktualisierung der Website nach X Sekunden
  String HTMLString = F("");
   String InTempOnOff1 = F("");
    ...
    CheckHumidity(); // Check Luftfeuchte
...
OWMA = F("href =\"/\"><button class=\"button\" style=\"margin-right: 10px; height: 26px; width: 90px;\" disabled>EIN</button></a>");
OWMA += F("<a href =\"/\"><button class=\"button\" style=\"margin-right: 10px; margin-left: 10px; height: 26px; width: 90px;\"disabled>AUS*</button></a>");
...
HTMLString =  F("<h2>Auswahl - aktuelle Wetterdaten von ---OpenWeatherMAP--- anzeigen &nbsp; EIN / AUS / STATUS:</h2>");
HTMLString += OWMA;
HTMLString += F("<p></p>");
HTMLString += F("<hr style=\"border-top: 3px solid #095484;margin-left: 0px;width: auto;\">");
return HTMLString;}
...
ANA = F("href =\"/\"><button class=\"button\" style=\"margin-right: 10px; height: 26px; width: 90px;\" disabled>EIN</button></a>");
ANA += F("<a href =\"/\"><button class=\"button\" style=\"margin-right: 10px; height: 26px; width: 90px;\"disabled>AUS*</button></a>");
...
HTMLString = F("<h2>Auswahl - aktuelle Nachrichten von ---NewsAPI--- anzeigen &nbsp; EIN / AUS / STATUS:</h2>");
HTMLString += ANA;
HTMLString += F("<p></p>");
HTMLString += F("<hr style=\"border-top: 3px solid #095484;margin-left: 0px;width: auto;\">");
return HTMLString;}
...
if (server.method() == HTTP_POST) {
    ...
    HTMLString += F("<br/>");
    HTMLString += F("<a href =\"/cdof\"><button>zurück zur Startseite</button></a>");
    HTMLString += F("</main>");
    HTMLString += F("</body>");
    HTMLString += F("</html>");
    SendHTMLString(HTMLString); // Send HTMLString
    ...
    HTMLString += F("<h5>(LED-Matrix-Display automatisch EIN / AUS)</h5>");
    HTMLString += F("<br/>");
    HTMLString += F("<h6>Fehler beim Speichern der Zugangsdaten und Einstellungen<br />Die Uhr wird neu gestartet</h6>");
    HTMLString += F("<br/>");
    HTMLString += F("<a href =\"/\"><button>zurück zur Startseite</button></a>");
    HTMLString += F("</main>");
    HTMLString += F("</body>");
