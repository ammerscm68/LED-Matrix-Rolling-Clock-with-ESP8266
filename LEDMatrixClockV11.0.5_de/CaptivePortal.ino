...
if (server.method() == HTTP_POST) {
    ...
    FederalState = server.arg(F("WBl")); // Bundesland in Deutschland
    ...
    GMCMapGMTOffset = server.arg(F("gmcmgmto")); // GMCMap GMT Offset 
    ...
    DHTSensor = server.arg(F("DHT")); // Auswahl DHT-Sensor [DHT11 oder DHT22]
