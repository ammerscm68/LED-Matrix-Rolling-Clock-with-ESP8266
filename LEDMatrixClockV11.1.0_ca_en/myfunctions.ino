...
if (HolidayDate == "11.1") {HoliDayText = F("Sir John A. Macdonald Day");} // Sir John A. Macdonald Day
if (HolidayDate == "15.2") {HoliDayText = F("National Flag Day");} // National Flag Day
if (HolidayDate == Second_Monday(3)) {HoliDayText = F("Commonwealth Day");}   // Commonwealth Day
if (HolidayDate == Second_Monday(10)) {HoliDayText = F("Thanksgiving");}   // Thanksgiving
if (HolidayDate == Monday_bevor_25_May()) {HoliDayText = F("Victoria Day");}   // Victoria Day
if (HolidayDate == "21.6") {HoliDayText = F("Celebrate Canada (1)");} // Celebrate Canada
if (HolidayDate == "22.6") {HoliDayText = F("Celebrate Canada (2)");} // Celebrate Canada
if (HolidayDate == "23.6") {HoliDayText = F("Celebrate Canada (3)");} // Celebrate Canada
if (HolidayDate == "24.6") {HoliDayText = F("Celebrate Canada (4)");} // Celebrate Canada
if (HolidayDate == "25.6") {HoliDayText = F("Celebrate Canada (5)");} // Celebrate Canada
if (HolidayDate == "26.6") {HoliDayText = F("Celebrate Canada (6)");} // Celebrate Canada
if (HolidayDate == "27.6") {HoliDayText = F("Celebrate Canada (7)");} // Celebrate Canada
if (HolidayDate == "28.6") {HoliDayText = F("Celebrate Canada (8)");} // Celebrate Canada
if (HolidayDate == "29.6") {HoliDayText = F("Celebrate Canada (9)");} // Celebrate Canada
if (HolidayDate == "30.6") {HoliDayText = F("Celebrate Canada (10)");} // Celebrate Canada
if (HolidayDate == "1.7") {HoliDayText = F("Celebrate Canada (11)");} // Celebrate Canada
if (HolidayDate == "7.9") {HoliDayText = F("Labour Day");} // Labour Day
if (HolidayDate == "25.12") {HoliDayText = F("Christmas Day");} // 1st Christmas Holiday
if (HolidayDate == "26.12") {HoliDayText = F("Boxing Day");} // Boxing Day
...
if (SerialMonitor) {
DEBUG_PRINTLN(F("")); 
DEBUG_PRINTLN("EasterSunday: "+String(EasterSunday)); // View EasterSunday Value
DEBUG_PRINTLN(F(""));} 
...
if (SerialMonitor) {DEBUG_PRINTLN(F("Load Clock Adjustments ..."));}
  ...
  if (NTPSN != "") {ntpServerName = NTPSN.c_str();} else {ntpServerName = "ca.pool.ntp.org";} // Default
 ...
 DEBUG_PRINTLN(F(""));}
  ...
  LoadClockStatus(); // Load the last Status of the Clock
    ...
    MCTZ = F("Coral Harbour, Pond Inlet, Atikokan, Toronto, Montreal, Ottawa"); // Default Time Zone
    ntpServerName = "ca.pool.ntp.org";  // Find local Server under http://www.pool.ntp.org/zone
    }
