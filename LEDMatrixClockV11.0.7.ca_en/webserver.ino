...
HTMLString = F("<!DOCTYPE html> <html lang='en-CA'>\
  ...
  <style>\
   ...
   h3 { font-size: 22px; margin-top: 0px; margin-bottom: 10px; margin-left: 10px;}\
  </style>\
  </head>\
    <body>\
    ...
    <a><br /></a>\
     ...
     <a><br /></a>\
     <a href =\"/goreset\"><button class=\"button\" style=\"margin-left: 0px;height: 48px; width: 110px; font-size: 22px; color: red\">Yes</button></a>\
  ...
  <style>\
   ...
   h3 { font-size: 28px; margin-top: 0px; margin-bottom: 10px; margin-left: 10px;}\
    ...
    <h1>LED-Matrix-Clock</h1>\
     ...
     <a><br /></a>\
     <a href =\"/reboot\"><button class=\"button\" style=\"margin-left: 0px;height: 48px; width: 110px; font-size: 22px; color: red\">YES</button></a>\
     <a href =\"/\"><button class=\"button\" style=\"margin-left: 80px;height: 48px; width: 110px; font-size: 22px;\">NO</button></a>\
  </body>\
    </html>"); 
OneTimeCall = true;        
...
if (server.method() == HTTP_POST) {
    ...
    if (DisplayOnTime == "!") {DisplayOnTime.clear();} 
    if (DisplayOffTime == "!") {DisplayOffTime.clear();}  
    HTMLString = F("<!doctype html><html lang='en-CA'>");
    ...
    if (DisplayOnTime == "NullOn") {DisplayOnTime.clear();}
    if (DisplayOffTime == "NullOff") {DisplayOffTime.clear();}    
    if (littleFSInit){
