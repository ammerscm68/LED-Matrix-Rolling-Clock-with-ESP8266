...
if (WebFunction == "NewsDataFunctionON1") {HTMLAnswerString = F("NewsData.io - Current News has been switched ON<br />When you Return to the Home Page<br />the LED Matrix Clock will Restart");}} else {
...
if (AccessGMCMap && AccessNewsData) {
if (WebFunction == "GMCMapFunctionON1") {HTMLAnswerString = F("GMCMap.com - Current Radioactivity Levels were Switched ON<br />When you Return to the Home Page<br />the LED Matrix Clock will Restart");}} else {
...
// ++++++++++++++++++++++++++++++++++++++++++++++ 
if (AccessGMCMap && AccessNewsData) {  
GMCMapFunction = false; // GMC disable due to lack of Memory
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
if (AccessGMCMap && AccessNewsData) {
NewsDataFunction = false;  // Disable News due to lack of Memory
StatusNewsData = F("disabled");
StatusWarningLED("LOW"); // LED off
RebootNow = true;
if (littleFSInit) {
