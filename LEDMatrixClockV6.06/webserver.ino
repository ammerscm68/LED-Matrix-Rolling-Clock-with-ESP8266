...
HTMLString += "<h5><a href =\"https://openweathermap.org/api\">( https://openweathermap.org/api )</a></h5>";
...
HTMLString += "<h5><a href =\"https://newsapi.org/s/germany-news-api\">( https://newsapi.org/s/germany-news-api )</a></h5>";
