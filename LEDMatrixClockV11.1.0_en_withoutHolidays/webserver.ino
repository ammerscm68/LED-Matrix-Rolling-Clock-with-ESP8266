...
if (SerialMonitor) {DEBUG_PRINTLN(F("Additional Functions switched on - (Date, Birthdays)"));} 
} else {HTMLAnswer("PW");}}
...
if (SerialMonitor) {DEBUG_PRINTLN(F("Additional Functions switched off - (Date, Birthdays)"));}
} else {HTMLAnswer("PW");}}
