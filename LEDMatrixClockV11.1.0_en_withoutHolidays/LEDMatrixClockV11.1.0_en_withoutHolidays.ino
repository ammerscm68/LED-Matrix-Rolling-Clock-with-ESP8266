 ...
 ** Date:    January 2026                                                                 **
 ** Version: 11.1.0 (English-UK) - without Holidays                                       ** 
 ...
 *******************************************************************************************
*/
const char* LMCVersion = "11.1.0 uk";
...
String DHTSensor = "NoDHT"; // DHT11 / DHT22 / NoDHT  /  false = DHT22   Sensor    (Output the Temperature in Celsius)
// #############################################################################################################################################
...
String StartDate; // Startdate / Time
...
// #####################################################################################
  ...
  StartDate = FormatedDateTimeEN(true); // Startdate / Time
...
// *************************************************************************************************************************************************************
Greetings(true); // First, greetings if available 
