 ...
 *******************************************************************************************
*/
const char* LMCVersion = "11.1.0 ca-fr";
...
String MidnightGhost = "OUI"; // OUI = afficher un fantôme à minuit / NON = ne pas afficher de Fantôme à minuit
// #############################################################################################################################################
...
// #############################################################################################################################################
int16_t MinRAMMem   = 15872; // Minimale RAM in Byte  par défaut = 15872
// #############################################################################################################################################
...
String StartDate; // Date / heure de début
...
// #####################################################################################
  ...
  StartDate = FormatedDateTimeFR(true); // Date / heure de début
...
await = false;} // Début de l'Horloge - Fin
  ...
  // Action de Minuit
  if (MidnightGhost == "OUI" || EnhancedFunctions) {
  ...
  if (IsEnoughRAM(MinRAMMem,"Météo") && IsWiFiSignalOK()) {getWeatherData();}} // // Déterminer les nouvelles heures de lever et de coucher du soleil
...
//##############################################################################################################################################
  ...
  if (IsEnoughRAM(MinRAMMem,"Nouvelles") && IsWiFiSignalOK()) {getNews();} else {APINews.clear();}} // obtenir des nouvelles actuelles
  // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  if (IsEnoughRAM(MinRAMMem,"Météo") && IsWiFiSignalOK()) {  // seulement si suffisamment de RAM est disponible
  SIC = true;
  getWeatherData(); // Obtenez les données météorologiques actuelles
  printStringWithShift("          ", ScrollTextTime);
