...
{ // Daten senden
  ...
  server.send(200, "text/html",RootHTMLString_1()); // 1. Teil
  MyWaitLoop(3); // kurze Pause sonst Absturz bei Browser refresh
