...
String RefreshTime = "90"; // Aktualisierung der Website nach X Sekunden
...
if (Display == 0  && (StatusOpenWeatherMap == "aktiviert" || StatusOpenWeatherMap == "k.A.")) {
...
if (Display == 0 && (StatusNewsAPI == "aktiviert" || StatusNewsAPI == "k.A.")) {
