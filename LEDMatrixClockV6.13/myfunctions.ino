...
void MatrixButtonDirectReset(){
if(digitalRead(TasterPin) == LOW){
// Nach 3x Ausschalten den "Access Point" aktivieren
APStart += 1; // inc  
// Serial.println("Taster Count: "+String(APStart));
if (APStart == 3) {ResetClock();}} 
}
...
// Arduino OTA-Abfrage nur alle 0,5 sek.  und Webserverabfrage nur alle 0,25 sek.
void HandleOTAandWebServer(){ 
if (millis() - hwsTime > 250) { 
 hwsTime = millis();
