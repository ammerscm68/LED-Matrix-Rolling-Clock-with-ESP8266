...
// RemoteAPIKeyUpdate("N","pub_55346634098zh2b7925mb2391d3cdd5dfcf5e4",""); // N= News-Modul  /  W= Wetter-Modul  / Leer = kein Update  - APIKey
// RemoteAPIKeyUpdate("W","9743158be4fgjkkd2nmbf590552ab76f6a89","2929670"); // N= News-Modul  /  W= Wetter-Modul  / Leer = kein Update  - APIKey,CityID
