...
if (HolidayDate == Third_Monday(1)) {HoliDayText = "Martin Luther King Day";}   // Martin Luther King Day
if (HolidayDate == Third_Monday(2)) {HoliDayText = "Presidents’ Day";}   // Washington’s Birthday
if (HolidayDate == Last_Monday(5)) {HoliDayText = "Memorial Day";}   // Memorial Day
if (HolidayDate == "19.6") {HoliDayText = "Juneteenth National Independence Day";} // Juneteenth National Independence Day
if (HolidayDate == "4.7") {HoliDayText = "Independence Day";}   // Independence Day
if (HolidayDate == First_Monday(9)) {HoliDayText = "Labor Day";}   // Labor Day
if (HolidayDate == Second_Monday(10)) {HoliDayText = "Columbus Day";}   // Columbus Day
if (HolidayDate == "11.11") {HoliDayText = "Veterans' Day";}   // Veterans' Day
if (HolidayDate == FourthThursday(11)) {HoliDayText = "Thanksgiving";}   // Thanksgiving
...
Serial.println("");}} else { // New Year's Eve
...
if (SerialMonitor) {
Serial.println("");   
Serial.println("Holiday: No Holiday");
...
void ShowGhost() {
String GShow = ""; 
if (SerialMonitor) {Serial.println("Witching Hour .....");} 
if (Display) {
...
if (SerialMonitor) {Serial.println("Load Clock Adjustments ...");}
  ...
  /*if (SerialMonitor) {
    Serial.println("*** Display On Time ***: "+DisplayOnTime+" Clock"); // for Debug Mode
    Serial.println("*** Display Off Time ***: "+DisplayOffTime+" Clock"); // for Debug Mode
...
if (!Start) {if (SerialMonitor) {Serial.println("WiFi Connection disconnected ...");}} else {StartFail = true;} 
} else
{
...
Serial.println("NTP-Time - Waiting for synchronization");}
...
if (SerialMonitor) {Serial.println("Reset - The Clock will Restart");}
