...
String ESPCore = ESP.getCoreVersion() + "&nbsp; ("+BoardName+")"; // Core Version
...
if (WebFunction == "NewsDataFunctionEin1")  {HTMLAnswerString = F("Die NewsData - aktuelle Nachrichten wurden eingeschaltet");}
if (WebFunction == "NewsDataFunctionEin2")  {HTMLAnswerString = F("Die NewsData - aktuelle Nachrichten sind bereits eingeschaltet");}
if (WebFunction == "NewsDataFunctionAus")   {HTMLAnswerString = F("Die NewsData - aktuelle Nachrichten wurden ausgeschaltet");}
...
HTMLAnswer("NewsDataFunctionEin1");
if (SerialMonitor) {Serial.println(F("NewsData - aktuelle Nachrichten eingeschaltet"));}}
else {
...
HTMLAnswer("GMCMapFunctionEin1");
if (SerialMonitor) {Serial.println(F("GMCMap - aktuelle Anzeige der Radioaktivität eingeschaltet"));}}
else {
HTMLAnswer("GMCMapFunctionEin2");
if (SerialMonitor) {Serial.println(F("GMCMap - aktuelle Anzeige der Radioaktivität ist bereits eingeschaltet"));}} 
} else {PleaseWait();}}
...
HTMLString += "<h2>Pushover-Gerätename2:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;k.A</h2>";}  
if (PushoverDevice3 != "") {
HTMLString += "<h2>Pushover-Gerätename3:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+PushoverDevice3+"</h2>";} else {
HTMLString += "<h2>Pushover-Gerätename3:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;k.A.</h2>";}  
...
if (server.method() == HTTP_POST) {
    ...
    HTMLString += F("</body>");
    HTMLString += F("</html>");  
    SendHTMLString(HTMLString);}} else {PleaseWait();}}  // Send HTMLString oder Warten
