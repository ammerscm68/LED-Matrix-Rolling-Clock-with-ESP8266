...
// Überprüfung einer Zeichenfolge, um festzustellen, ob sie vom Typ Float ist, und akzeptieren vom Dezimalpunkt
...
if (LEDStatus == "LOW") {
if (!Display || StatusGMCMap == "deaktiviert") {digitalWrite(HWLEDPin, LOW);} else { 
