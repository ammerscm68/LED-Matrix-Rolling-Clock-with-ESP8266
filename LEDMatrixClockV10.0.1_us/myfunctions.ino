...
if (LEDStatus == "HIGH") {if (GMCMapToHigh != "" || GMCMapValue == "NoGMCMapValue" || 
InHumidityStatus == "MIN" || InHumidityStatus == "MAX") {
digitalWrite(HWLEDPin, HIGH);}}
if (LEDStatus == "LOW") {
if (!Display || StatusGMCMap == "disabled") {digitalWrite(HWLEDPin, LOW);} else { 
if ((InHumidityStatus == "NORMAL"|| InHumidityStatus == "FAIL") && 
GMCMapToHigh == "" && GMCMapValue != "NoGMCMapValue") {digitalWrite(HWLEDPin, LOW);}}}}}}
