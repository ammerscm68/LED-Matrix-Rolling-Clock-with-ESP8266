...
if (MCTZ != "Berlin, Frankfurt, Wien, Paris, Madrid" && 
    ...
    MCTZ != "Whitehorse") {MCTZ = "Coral Harbour, Pond Inlet, Atikokan, Toronto, Montreal, Ottawa"; tTlocal = caET.toLocal(tT);}
return tTlocal;  
}
...
getTimeLocal(); // récupère l'heure actuelle
  ...
  refreshAll();
  if (AnimWait) {MyWaitLoop(ScrollClockTime);}} // Vitesse de défilement du temps
