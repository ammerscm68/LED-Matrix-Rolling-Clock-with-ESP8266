...
{ // &nbsp = Leerzeichen | <meta http-equiv=\"refresh\" content=\"30\">\ = Refresh alle 30 sekunden
  ...
  if (ScrollTextTime == 30) {STL1 = "Stufe 1*";} else {STL1 = "Stufe 1";}
  if (ScrollTextTime == 40) {STL2 = "Stufe 2*";} else {STL2 = "Stufe 2";}
  ...
  yield();
  delay(100); // kurze Pause sonst Absturz bei Browser refresh
  String HTMLString; 
