...
String authors[authors_Count] = {"Tagesschau.de", "Bild", "Der Spiegel", "WDR Nachrichten", "n-tv NACHRICHTEN",
                                 ...
                                 "finanzen.net", "MDR", "Zeit.de", "FAZ - Frankfurter Allgemeine Zeitung"};  // German Authors
/*****************************************************************************************************************************/ 
...
Serial.println("News werden heruntergeladen - Bitte warten ...");} 
 ...
 // DynamicJsonDocument doc2(ESP.getMaxAllocHeap()); // for ESP32
    ...
    if (SerialMonitor) {Serial.println("Fehler beim Parsen der Newsdaten... !");}}
    doc2.clear();
    } else {
