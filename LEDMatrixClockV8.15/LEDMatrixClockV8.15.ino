...
String SHT= "               Hallo  "+WatchOwner1FirstName+"                 "; 
printStringWithShift(SHT.c_str(), ScrollTextTime);}
if (WatchOwner2FirstName != "") {
String SHT= "               Hallo  "+WatchOwner2FirstName+"                 "; 
printStringWithShift(SHT.c_str(), ScrollTextTime);}
if (WatchOwner3FirstName != "") {
String SHT= "               Hallo  "+WatchOwner3FirstName+"                 "; 
printStringWithShift(SHT.c_str(), ScrollTextTime);}
// *************************************************
sendCmdAll(CMD_SHUTDOWN,0); // Display aus
...
await = false;
  ...
  // Ghost at Midnight
  if (MidnightGhost) {  
  if (String(h) == "0" && String(m) == "0" && String(s) == "5") {
