...
if (SerialMonitor) {DEBUG_PRINTLN(F("Charger les Ajustements de l’Horloge ..."));}
 ...
 // Sélection du Capteur DHT [DHT11 ou DHT22]
 ...
 if (SerialMonitor) {
 DEBUG_PRINTLN(F(""));  
 DEBUG_PRINTLN(F("Sélection du Capteur DHT : [DHT11 / DHT22] ")+ DHTSensor);
 DEBUG_PRINTLN(F(""));}
...
int16_t ESPRAM = ESP.getFreeHeap(); // Check RAM
bool ByteRAM = false;
if (SerialMonitor) {
DEBUG_PRINTLN(F(""));
