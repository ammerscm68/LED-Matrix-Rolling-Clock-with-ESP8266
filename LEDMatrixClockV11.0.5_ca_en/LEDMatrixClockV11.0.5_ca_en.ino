 ...
 *******************************************************************************************
*/
const char* LMCVersion = "11.0.5 ca-en";
...
// ####################### Presetting the Time Zone in which the Clock is located (Changes possible in the Captiv Portal) ######################
String MCTZ = "Coral Harbour, Pond Inlet, Atikokan, Toronto, Montreal, Ottawa";
// #############################################################################################################################################

// #############################################################################################################################################
String NTPSN = "ca.pool.ntp.org";
const char* ntpServerName = "ca.pool.ntp.org";  // Finde lokale Server unter http://www.pool.ntp.org/zone
// #############################################################################################################################################
