void DHTHTML() { 
  ...
  // Serial.println("Innentemperatur: "+InTempValue+" °C");
  InHumValue = InHumMessure(); // Luftfeuchte Wert abrufen
  int IntInHumValue = InHumValue.toInt();
  // Serial.println("Innentemperatur: "+InHumValue+" %");
  ...
  HumValueColor = "style=\"color: #FC1E17; font-size: 16px; margin-left: 435px;\">bei einer Luftfeuchte von:&nbsp;"+InHumValue+"";} else {  
  HumValueColor = "style=\"color: lime; font-size: 16px; margin-left: 435px;\">bei einer Luftfeuchte von:&nbsp;"+InHumValue+"";}
...
String InTempMessure() {
  ...
  String ITempValue = String(TempWert+InTempOffset,0); 
...
String InHumMessure() {
  ...
  String IHumValue = String(LfWert+InHumOffset,0); 
  // Serial.println("Luftfeuchte: "+IHumValue); // nur im Debugmodus
