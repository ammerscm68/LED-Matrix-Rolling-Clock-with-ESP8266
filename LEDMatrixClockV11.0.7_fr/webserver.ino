...
HTMLString = F("<!DOCTYPE html> <html lang='fr'>\
  ...
  <style>\
   ...
   h3 { font-size: 28px; margin-top: 0px; margin-bottom: 10px; margin-left: 10px;}\
    ...
    <a><br /></a>\
     <h3>Réinitialisation de l'Horloge à Matrice LED !</h3>\
     <h2>(Les données d'Accès WLAN seront Supprimées)</h2>\
     <a><br /></a>\
     <h2>Maintenant, Réinitialisez l'Horloge Matricielle LED ?</h2>\
     <a><br /></a>\
     <a href =\"/goreset\"><button class=\"button\" style=\"margin-left: 0px;height: 48px; width: 110px; font-size: 22px; color: red\">Oui</button></a>\
     <a href =\"/\"><button class=\"button\" style=\"margin-left: 80px;height: 48px; width: 110px; font-size: 22px;\">Non</button></a>\
  </body>\
    </html>");  
SendHTMLString(HTMLString); // Envoyer une chaîne HTML
MyWaitLoop(100);
...
HTMLString = F("<!DOCTYPE html> <html lang='fr'>\
  ...
  <style>\
   ...
   h3 { font-size: 28px; margin-top: 0px; margin-bottom: 10px; margin-left: 10px;}\
    ...
    <h1>Horloge-Matricielle-LED</h1>\
     <a><br /></a>\
     <h3>Mémoire vive insuffisante !</h3>\
     <h2>(Redémarrer l'Horloge résout le Problème.)</h2>\
     <a><br /></a>\
     <h2>Redémarrer l'Horloge Matricielle LED maintenant ?</h2>\
     <a><br /></a>\
     <a href =\"/reboot\"><button class=\"button\" style=\"margin-left: 0px;height: 48px; width: 110px; font-size: 22px; color: red\">OUI</button></a>\
     <a href =\"/\"><button class=\"button\" style=\"margin-left: 80px;height: 48px; width: 110px; font-size: 22px;\">NON</button></a>\
  </body>\
    </html>"); 
OneTimeCall = true;        
...
await = false;
if (SerialMonitor) {DEBUG_PRINTLN(F("Le Buzzer horaire activé"));}} else {PleaseWait();}
