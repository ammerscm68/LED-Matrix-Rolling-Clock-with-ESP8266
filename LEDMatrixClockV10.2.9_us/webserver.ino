...
if (!await) {   
// Serial.println(F("Additional Functions switched off"));
...
if (SerialMonitor) {
Serial.println(F("NewsData - Current News has been switched ON"));
if (AccessGMCMap && AccessNewsData) {Serial.println(F("+++   The Clock will restart   +++"));}}
...
if (SerialMonitor) {Serial.println(F("NewsData - Current News is switched off"));}
} else {PleaseWait();}}
...
if (SerialMonitor) {
Serial.println(F("GMCMap - Current Radioactivity Levels were Switched ON"));
if (AccessGMCMap && AccessNewsData) {Serial.println(F("+++   The Clock will restart   +++"));}}
HTMLAnswer("GMCMapFunctionON1");} else {
HTMLAnswer("GMCMapFunctionON2");
if (SerialMonitor) {Serial.println(F("GMCMap - Current Radioactivity Levels are already Switched ON"));}} 
} else {PleaseWait();}}
...
if (SerialMonitor) {Serial.println(F("Additional Functions switched on - (Date, Birthdays, Holidays)"));} 
} else {PleaseWait();}}
...
if (SerialMonitor) {Serial.println(F("Additional Functions switched off - (Date, Birthdays, Holidays)"));}
} else {PleaseWait();}}
