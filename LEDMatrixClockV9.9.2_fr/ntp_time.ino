...
// Heure d'Europe Centrale (Frankfurt, Paris)
TimeChangeRule CEST = {"CEST", Last, Sun, Mar, 2, 120};     // Heure d'été d'Europe Centrale
TimeChangeRule CET = {"CET ", Last, Sun, Oct, 3, 60};       // Heure Standard d’Europe Centrale
