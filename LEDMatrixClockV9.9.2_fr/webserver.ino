...
OWMA += F("<a style=\"font-family:arial;color:#ffcc00; font-size: 16px; margin-left: 40px;\">Status: &nbsp;+++ Pas de Téléchargement des Données Météo en Affichage ARRÊT +++</a>");}
} else {
...
ANA += F("<a style=\"font-family:arial;color:#ffcc00; font-size: 16px; margin-left: 40px;\">Status: &nbsp;+++ Pas de Téléchargement des Messages lorsque Affichage ARRÊT +++</a>");}
} else {
