...
{ // &nbsp = Leerzeichen | <meta http-equiv=\"refresh\" content=\"30\">\ = Refresh alle 30 sekunden 
  ...
  <h1>+++ LED-Matrix-Uhr +++</h1>\
    ...
    <a href =\"/owmfein\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 90px;\">"+OWMF1+"</button></a>\
    <a href =\"/owmfaus\"><button class=\"button\" style=\"margin-right: 10px;height: 26px; width: 90px;\">"+OWMF2+"</button></a>\
    <p></p>\
    <hr style=\"border-top: 3px solid #095484;margin-left: 0px;width: auto;\">\
...
HTMLString = "<!DOCTYPE html> <html>\
  ...
  <h1>+++ LED-Matrix-Uhr +++</h1>\
    ...
    <body>\
    <font face=\"Arial\">\
     <a style=\"font-family:arial;color:black;font-size: 16px\">Zusatzfunktionen eingeschaltet (Datum, Feiertage, Geburtstage)</a>\
    <a><br /></a>\
    <a><br /></a>\
    <a href =\"/\"><button class=\"button\" style=\"margin-left: 10px;height: 28px; width: 160px\">zurück zur Startseite</button></a>\
  </body>\
...
HTMLString = "<!DOCTYPE html> <html>\
  ...
  <h1>+++ LED-Matrix-Uhr +++</h1>\
    ...
    <body>\
    <font face=\"Arial\">\
     <a style=\"font-family:arial;color:black;font-size: 16px\">Zusatzfunktionen ausgeschaltet (Datum, Feiertage, Geburtstage)</a>\
    <a><br /></a>\
    <a><br /></a>\
    <a href =\"/\"><button class=\"button\" style=\"margin-left: 10px;height: 28px; width: 160px\">zurück zur Startseite</button></a>\
  </body>\
