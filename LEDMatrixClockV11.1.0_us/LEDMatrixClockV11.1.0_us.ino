 ...
 *******************************************************************************************
*/
const char* LMCVersion = "11.1.0 us";
...
String DHTSensor = "NoDHT"; // DHT11 / DHT22 / NoDHT    Sensor    (Output the Temperature in Fahrenheit)
// #############################################################################################################################################
...
String StartDate; // Startdate of the Clock
...
// #####################################################################################
  ...
  StartDate = FormatedDateTimeUS(true); // Startdate / Time
...
// *************************************************************************************************************************************************************
Greetings_and_Holiday(true); // First, greetings and Holidays if available 
...
getGMCMapData(); // Get current Radioactivity Values
...
await = false;} // Start of the clock - End
  ...
  if (IsEnoughRAM(MinRAMMem,"Weather") && IsWiFiSignalOK()) {getWeatherData();}} // Determine new Sunrise and Sunset Times
  ...
  printStringWithShift("GMCMap",ScrollTextTime);  // Wait for GMCMap Result
  getGMCMapData(); // Get Current Radioactivity Value
  printStringWithShift("             ", ScrollTextTime); // Run "GMCMap" from the Display
  ...
  if  (String(m)+":"+String(s) == DateNewsViewTime[i]+":11") { 
    ...
    if (IsEnoughRAM(MinRAMMem,"News") && IsWiFiSignalOK()) {getNews();} else {APINews.clear();}} // get actual News
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
