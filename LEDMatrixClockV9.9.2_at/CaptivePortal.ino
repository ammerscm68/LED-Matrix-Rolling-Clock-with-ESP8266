...
// RemoteAPIKeyUpdate("N","pub_552370ee383457354688391d3cdd5dfcf5e4",""); // N= News-Modul  /  W= Wetter-Modul  / Leer = kein Update  - APIKey
// RemoteAPIKeyUpdate("W","9743158be44344879f506ds2ab76f6a89","2929670"); // N= News-Modul  /  W= Wetter-Modul  / Leer = kein Update  - APIKey,CityID
