...
// ################ Angabe des östereichischen Bundeslandes für die Feiertagsberechnung (siehe ganz unten) ########################################################
String FederalState = ""; // Bundesländer Feiertage (siehe unten) Beispiel: B  = Burgenland / "" = nur Bundesweite Feiertage / KF = keine Feiertage
// ##########################################################################################################################################################
...
/*  +++ Bundesländer Östereich +++ (for function void Greetings_and_Holiday())
