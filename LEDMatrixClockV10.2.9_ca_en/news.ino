// **********************************(newsdata.io)******************************************
// Test -->  https://newsdata.io/api/1/latest?country=ca&language=en&apikey==yourAPIKey
// *****************************************************************************************
...
/*****************************************************************************************************************************/
int authors_Count = 14;  
String authors[authors_Count] = {"Digital Journal", "Chek News", // Json "source_name" CA Authors
                                 "Global News", "Cbc", "Victoria News", 
                                 "Vernon Morning Star", "Kelowna Capital News", "The Standard", "Investing Canada", 
                                 "Ctv News", "Cp24", "Kamloops This Week", "The Star", "Richmond News"};

/*****************************************************************************************************************************/ 
String Country = F("ca"); // Country Default is ca = canadian
...
HTTPClient http;  
  ...
  //DynamicJsonDocument doc2(ESP.getMaxFreeBlockSize() - 1024); // for ESP8266 
    ...
    Serial.println(F(""));}}} else {APINews = F("     +++       Connection to NewsData-Server failed !     +++              ");  
WPAPINews = F("+++ Connection to NewsData-Server failed ! +++"); 
StatusNewsData = F("Error");  
client.stop();
