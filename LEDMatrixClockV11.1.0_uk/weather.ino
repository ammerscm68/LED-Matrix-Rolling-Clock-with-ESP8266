...
if(httpCode == HTTP_CODE_OK) {
   ...
   // DynamicJsonDocument doc(256) ;  // Json-Dokument
    ...
    WPweatherString = "+++ The Current Weather Data for " + weatherLocation + ":    ---    "; // City Name
    ...
    if (SerialMonitor) {
    DEBUG_PRINTLN("Weather Data from: "+FormatedDateTimeEN(false));
    DEBUG_PRINTLN("The Current Weather Data for " + weatherLocation+":");
	  DEBUG_PRINTLN("Weather Conditions: "+ weatherMain);
    DEBUG_PRINTLN("Outdoor Temperature: " + String(temp, 0) + " °C");
    // DEBUG_PRINTLN("Minimum Temperature: " + String(tempMin, 1) + " °C");
    // DEBUG_PRINTLN("Maximum Temperature: " + String(tempMax, 1) + " °C");
    ...
    DEBUG_PRINTLN("Wind Speed: " + String(windSpeed*3.6, 0) + " km/h");
