 ...
 ********************************************************************************************
*/
const char* LMCVersion = "11.0.7 de";
...
// ++++ Check DHTSensor Variable +++++++++++
if (DHTSensor != "DHT11" && 
DHTSensor != "DHT22" && 
DHTSensor != "NoDHT") {DHTSensor = "NoDHT";}
// +++++++++++++++++++++++++++++++++++++++++
...
await = false;} // Start der Uhr - Ende
  ...
  MEP=true; getGMCMapData(); MEP=false; // aktuelle Radioaktivitätswerte holen
  printStringWithShift("             ", ScrollTextTime); // GMCMap aus dem Display laufen lassen
  GMCMapMessage(10,5);}} // GMCMap Daten Auswerten und Anzeigen oder RAM defragmentieren
