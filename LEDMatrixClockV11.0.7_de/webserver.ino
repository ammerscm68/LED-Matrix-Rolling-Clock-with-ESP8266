  ...
  <style>\
   ...
   h3 { font-size: 28px; margin-top: 0px; margin-bottom: 10px; margin-left: 10px;}\
    ...
    <a><br /></a>\
     ...
     <a><br /></a>\
     <a href =\"/goreset\"><button class=\"button\" style=\"margin-left: 0px;height: 48px; width: 110px; font-size: 22px; color: red\">JA</button></a>\
...
HTMLString = F("<!DOCTYPE html> <html lang='de'>\
  ...
  <style>\
   body { background-color: #585858; font-size: 32px; font-family: Arial, Helvetica, Sans-Serif; color: #F2F2F2; text-align:center;}\
   h1 { color: #2ECCFA; margin-top: 30px; margin-bottom: 0px; }\
   h2 { font-size: 22px; margin-top: 0px; margin-bottom: 10px;}\
   h3 { font-size: 28px; margin-top: 0px; margin-bottom: 10px;}\
  </style>\
  </head>\
    <body>\
    <h1>LED-Matrix-Uhr</h1>\
     ...
     <a><br /></a>\
     <a href =\"/reboot\"><button class=\"button\" style=\"margin-left: 0px;height: 48px; width: 110px; font-size: 22px; color: red\">JA</button></a>\
     <a href =\"/\"><button class=\"button\" style=\"margin-left: 80px;height: 48px; width: 110px; font-size: 22px;\">NEIN</button></a>\
  </body>\
    </html>"); 
OneTimeCall = true;        
