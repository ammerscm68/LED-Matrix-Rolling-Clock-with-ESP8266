...
String authors[authors_Count] = {"SALZBURG24", "Sky Sport Austria", "film.at", "ORF.at", "DER STANDARD",
                                 "Kronen Zeitung", "finanzen.net", "meinbezirk.at"};  // Austria Authors
/*****************************************************************************************************************************/ 
String Country = F("at"); // Default at = Austria
/*****************************************************************************************************************************/
...
StatusNewsAPI = F("k.A."); 
NewsAPILastConnectionDateTime = FormatedDateTimeDE(true); // Connection Time;
...
Serial.println(F("News werden heruntergeladen - Bitte warten ..."));} 
 ...
 // DynamicJsonDocument doc2(ESP.getMaxAllocHeap()); // for ESP32
    ...
    if (articles_author == authors[l]) {aFound = true;}} // Autoren-Filter
    if (aFound){ 
    if (articles_title != "") {
