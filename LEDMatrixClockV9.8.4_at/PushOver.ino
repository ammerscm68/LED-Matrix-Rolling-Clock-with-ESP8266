...
SendPushoverMessage("Testnachricht für "+PushoverDevice2,PushoverDevice2,PushoverMessageSound); // Nachricht an Gerät 1 
...
SendPushoverMessage("Testnachricht für "+PushoverDevice3,PushoverDevice3,PushoverMessageSound); // Nachricht an Gerät 1 
