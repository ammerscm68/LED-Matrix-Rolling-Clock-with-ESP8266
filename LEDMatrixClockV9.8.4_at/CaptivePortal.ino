...
if (server.method() == HTTP_POST) {
    ...
    FederalState = server.arg("WBl"); // Bundesland in Österreich
...
int n = WiFi.scanNetworks(false, false); //WiFi.scanNetworks(async, show_hidden)
    ...
    HTMLString += F("<br/>");
    // ******************************************* Parameter ************************************************************************************************************************************
    HTMLString += "<div class='form-floating'><br/><label style=\"margin-left: 6px; font-weight: bold;\">+++ OpenWeatherMap und NewsAPI (Optional) +++</label></div>";
