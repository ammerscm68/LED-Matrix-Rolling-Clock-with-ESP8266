...
HTMLString += "h3 { font-size: 16px; margin-top: 0px; margin-bottom: 30px; margin-left: 10px;}";
...
if (StatusOpenWeatherMap == "OK") {
HTMLString += "<h6>*) Normal= 1013 hPa</h6>";
HTMLString += "<h6>&nbsp;&nbsp;&nbsp;niedriger= es folgt schlechtes Wetter</h6>";
HTMLString += "<h6>&nbsp;&nbsp;&nbsp;höher= es folgt gutes Wetter</h6>";}
HTMLString += "<a><br /></a>";
HTMLString += "<a href =\"/\"><button class=\"button\" style=\"margin-left: 10px;height: 48px; width: 160px\">zurück zur Startseite</button></a>";
HTMLString += "</body>";
HTMLString += "</html>";
