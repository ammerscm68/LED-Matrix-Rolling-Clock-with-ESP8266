...
/*****************************************************************************************************************************/
byte authors_Count = 10;  // Maximum: 255
String authors[authors_Count] = {F("Salzburger Nachrichten"), F("Euronews"),  // Json "source_name" Österreichische Autoren
                                 F("Tiroler Tageszeitung"), F("Kleine Zeitung"), F("Die Presse"), 
                                 F("Oe24"), F("Der Standard"), F("Kurier"), F("Orf"), F("Meinbezirk")};
