...
int BDCounter = 0; // Zähler für Geburtstagsgrüße und News
...
// nur Innen- und Außenluftfeuchte --- 3x pro Stunde (default)
  ...
  if  (String(m)+":"+String(s) == DateNewsViewTime[i]+":8") { 
    ...
    if (BDCounter == 0) {Greetings_and_Holiday(false);} else {GreetingsToday = false;}
    BDCounter++;
    if (BDCounter > 1) {BDCounter = 0;}} // Abwechselnd Grüße und Feiertage sowie News anzeigen
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
